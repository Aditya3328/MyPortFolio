...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
"automation, and reliable deployment pipelines.",
"#ffffff"
)}
...
${this.wrapWithColor(
"   using GitLab, Docker, Kubernetes, AWS, and Terraform",
"#ff8c00"
)}

${this.wrapWithColor("⚡ Passion", "#ff8c00")}
${this.wrapWithColor(
"   Improving deployment reliability and system scalability",
"#ffffff"
)}
${this.wrapWithColor(
"   through infrastructure automation and DevOps practices",
"#ffffff"
)}

${this.wrapWithColor("⚡ Strengths", "#ff8c00")}
${this.wrapWithColor(
"   CI/CD pipeline design, container orchestration,",
"#ffffff"
)}
${this.wrapWithColor(
"   cloud infrastructure, and Linux system administration",
"#ffffff")}
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
"Always learning & building better automation systems.",
"#ffffff"
...
<span style="color: #00ffff;">SUNFIRE TECHNOLOGIES | DevOps Associate</span>
${this.wrapWithColor(
  "Mar 2025 – Present | Pune, India",
  "#ffffff"
)}

• ${this.wrapWithColor("CI/CD Engineer", "#ffa07a")} - ${this.wrapWithColor(
  "Built and maintained automated pipelines using GitLab CI/CD",
  "#ffffff"
)}
• ${this.wrapWithColor("Containerization", "#ffa07a")} - ${this.wrapWithColor(
  "Containerized applications using Docker and deployed on Kubernetes",
  "#ffffff"
)}
• ${this.wrapWithColor("Cloud Infrastructure", "#ffa07a")} - ${this.wrapWithColor(
  "Managing AWS infrastructure (EC2, S3, IAM, VPC)",
  "#ffffff"
)}
• ${this.wrapWithColor("Infrastructure Automation", "#ffa07a")} - ${this.wrapWithColor(
  "Provisioning infrastructure using Terraform",
  "#ffffff"
)}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
  "AWS, Docker, Kubernetes, Terraform, GitLab CI/CD, Linux, Bash",
  "#87cefa"
)}


<span style="color: #00ffff;">REQ EDU TECHNOLOGIES | Web Application Developer</span>
${this.wrapWithColor(
  "Aug 2023 – Feb 2025 | Pune, India",
  "#ffffff"
)}
...
• ${this.wrapWithColor("Feature Development", "#ffa07a")} - ${this.wrapWithColor(
...
• ${this.wrapWithColor("Team Collaboration", "#ffa07a")} - ${this.wrapWithColor(
  "Worked with developers on testing and deployment workflows",
  "#ffffff"
)}
...
<span style="color: #00ffff;">CONNEXIONS | Software Engineer</span>
${this.wrapWithColor(
  "Dec 2019 – Nov 2021 | Pune, India",
  "#ffffff"
)}

• ${this.wrapWithColor("Backend Development", "#ffa07a")} - ${this.wrapWithColor(
  "Developed backend services using Ruby on Rails",
  "#ffffff"
)}
• ${this.wrapWithColor("Application Architecture", "#ffa07a")} - ${this.wrapWithColor(
  "Designed scalable modules and integrated database systems",
  "#ffffff"
)}
• ${this.wrapWithColor("System Optimization", "#ffa07a")} - ${this.wrapWithColor(
  "Improved application performance and reliability",
  "#ffffff"
)}
• ${this.wrapWithColor("Deployment Support", "#ffa07a")} - ${this.wrapWithColor(
  "Contributed to testing, deployment, and maintaining code quality",
  "#ffffff"
)}
...
${this.wrapWithColor("🏛️ College:", "#ff8c00")} ${this.wrapWithColor(
"ASM's College of Commerce, Science & IT, Pimpri",
"#ffffff"
)}
${this.wrapWithColor("🎓 University:", "#ff8c00")} ${this.wrapWithColor(
...
${this.wrapWithColor("🏛️ College:", "#ff8c00")} ${this.wrapWithColor(
"Krantisinh Nana Patil College, Walwa",
"#ffffff"
)}
${this.wrapWithColor("🎓 University:", "#ff8c00")} ${this.wrapWithColor(
"Shivaji University",
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
" Academic foundation for my software engineering journey ",
"#ffffff"
)}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
"╰─────────────────────────────────────────────────────────╯",
...
const skills = `<span style="color: #ffff00; font-weight: bold;">🛠️ DEVOPS STACK</span>

${this.wrapWithColor("☁️ Cloud Platforms", "#00ff9c")}
• ${this.wrapWithColor("AWS (EC2, S3, IAM, VPC, EBS, EFS)", "#ffffff")}

${this.wrapWithColor("🐳 Containers & Orchestration", "#00ff9c")}
• ${this.wrapWithColor("Docker", "#ffffff")}
• ${this.wrapWithColor("Kubernetes", "#ffffff")}

${this.wrapWithColor("⚙️ CI/CD", "#00ff9c")}
• ${this.wrapWithColor("GitLab CI/CD", "#ffffff")}
• ${this.wrapWithColor("GitLab Runner", "#ffffff")}
• ${this.wrapWithColor("CI/CD Pipeline Design", "#ffffff")}
• ${this.wrapWithColor("Artifact Management", "#ffffff")}

${this.wrapWithColor("🏗️ Infrastructure as Code", "#00ff9c")}
• ${this.wrapWithColor("Terraform", "#ffffff")}
• ${this.wrapWithColor("Terraform Modules", "#ffffff")}

${this.wrapWithColor("🖥️ Operating Systems", "#00ff9c")}
• ${this.wrapWithColor("Linux Administration", "#ffffff")}
• ${this.wrapWithColor("Shell / Bash Scripting", "#ffffff")}
• ${this.wrapWithColor("System Monitoring", "#ffffff")}
• ${this.wrapWithColor("Package Management", "#ffffff")}

${this.wrapWithColor("💻 Programming / Scripting", "#00ff9c")}
• ${this.wrapWithColor("Ruby", "#ffffff")}
...
'<a href="https://aditya-kadam.netlify.app/" target="_blank" style="color:#ffffff;text-decoration:none;">aditya-kadam.netlify.app</a>',
"#ffffff"
)}
...
'<a href="https://github.com/Aditya3328" target="_blank" style="color:#ffffff;text-decoration:none;">github.com/Aditya3328</a>',
"#ffffff"
)}
...
'<a href="https://linkedin.com/in/aditya-kadam24" target="_blank" style="color:#ffffff;text-decoration:none;">linkedin.com/in/aditya-kadam24</a>',
"#ffffff"
)}
...
'<a href="https://gitlab.com/aditya__kadam" target="_blank" style="color:#ffffff;text-decoration:none;">gitlab.com/aditya__kadam</a>',
"#ffffff"
)}

${this.wrapWithColor("╭────────────────────────────────────────────────╮", "#ff8c00")}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
"Open to DevOps opportunities and collaboration",
"#ffffff"
)} ${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor("╰────────────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  loadProjects() {
    this.projects = [
      {
        title: "Interactive DevOps Terminal",
        description: "Terminal-based portfolio that simulates a real DevOps console with commands for skills, experience, projects, and contact information.",
        image: "path/to/project-image.jpg",
        technologies: ["JavaScript", "HTML", "CSS"],
        demo: "https://aditya-kadam.netlify.app/",
        repo: "https://github.com/Aditya3328",
      },
	  {
        title: "GitLab CI/CD Pipeline Automation",
        description: "Automated CI/CD pipeline for building, testing, and deploying containerized applications using GitLab CI/CD.",
        image: "path/to/project-image.jpg",
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
    ...
    subtitle.textContent = "Interactive DevOps Terminal";
